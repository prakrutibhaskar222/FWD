...
export default function LandscapeGardening({ setActive }) {
  return (
    <div className="min-h-screen bg-[#e2d7c1] text-[#1a1a1a] font-sans">
      ...
      <section className="text-center px-6 md:px-20 py-16 bg-gradient-to-b from-amber-100 to-white">
        ...
        <p className="text-black text-lg max-w-3xl mx-auto leading-relaxed">
          Keep your garden healthy, clean, and beautifully maintained with our 
          professional gardening and landscaping services. From trimming and 
          lawn care to plant health and seasonal cleanup — we've got it covered.
        </p>
      </section>
      ...
      <section className="px-8 md:px-20 py-20 max-w-4xl mx-auto">
        ...
        <div className="space-y-6">
          {[
            "We visit your space to assess garden size, plant types, and maintenance needs.",
            "Our team performs lawn mowing, trimming, pruning, deweeding, soil care, and cleanup.",
            "We provide plant health checks and offer suggestions for better outdoor maintenance.",
          ].map((text, index) => (
            <motion.div
              key={index}
        ...
        <div className="mt-16 bg-white rounded-xl shadow-lg p-8 border border-gray-100">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 text-center">
            <div>
              ...
              <p className="text-xl text-black mt-2">2 – 6 hours</p>
            </div>
            <div>
              <p className="text-gray-600 font-medium">💰 Price</p>
              <p className="text-xl text-black mt-2">₹1,200 – ₹5,000</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="text-center bg-black text-white py-20">
        <h2 className="text-3xl font-light mb-6">Want a Beautiful, Well-Maintained Garden?</h2>
