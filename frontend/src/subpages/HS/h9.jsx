...
export default function KitchenCleaning({ setActive }) {
  return (
    <div className="min-h-screen bg-[#e2d7c1] text-[#1a1a1a] font-sans">
      ...
      <section className="text-center px-6 md:px-20 py-16 bg-gradient-to-b from-amber-100 to-white">
        ...
        <p className="text-black text-lg max-w-3xl mx-auto leading-relaxed">
          Get a sparkling clean kitchen with our professional deep cleaning 
          service. We remove grease, stains, oil buildup, food spills, and 
          bacteria from all surfaces to give your kitchen a fresh and hygienic look.
        </p>
      </section>
      ...
      <section className="px-8 md:px-20 py-20 max-w-4xl mx-auto">
        ...
        <div className="space-y-6">
          {[
            "We assess your kitchen to identify tough grease, stains, and cleaning requirements.",
            "Deep cleaning of countertops, stovetops, tiles, chimney exterior, sink, shelves, cabinets, and appliances.",
            "Final sanitization ensures a hygienic, odor-free, and spotless kitchen environment.",
          ].map((text, index) => (
            <motion.div
              key={index}
      ...
      <section className="text-center bg-black text-white py-20">
        <h2 className="text-3xl font-light mb-6">Need a Clean & Fresh Kitchen?</h2>
