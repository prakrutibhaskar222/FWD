...
export default function NewHouseSetup({ setActive }) {
  return (
    <div className="min-h-screen bg-[#e2d7c1] text-[#1a1a1a] font-sans">
      ...
      <section className="text-center px-6 md:px-20 py-16 bg-gradient-to-b from-amber-100 to-white">
        ...
        <p className="text-black text-lg max-w-3xl mx-auto leading-relaxed">
          Moving into a new home? Our professional setup service helps you 
          arrange furniture, unpack essentials, organize rooms, install basic 
          fittings, and turn your new house into a comfortable, ready-to-live space.
        </p>
      </section>
      ...
      <section className="px-8 md:px-20 py-20 max-w-4xl mx-auto">
        ...
        <div className="space-y-6">
          {[
            "We inspect your new home layout and understand your organization preferences.",
            "Our team helps unpack, arrange furniture, set up bedrooms, kitchen, and living room.",
            "Final touch-up includes cleaning, organizing essentials, and making your home ready to move in.",
          ].map((text, index) => (
            <motion.div
              key={index}
        ...
        <div className="mt-16 bg-white rounded-xl shadow-lg p-8 border border-gray-100">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 text-center">
            ...
            <div>
              ...
              <p className="text-xl text-black mt-2">₹2,000 – ₹8,000</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="text-center bg-black text-white py-20">
        <h2 className="text-3xl font-light mb-6">Ready to Set Up Your New Home?</h2>
