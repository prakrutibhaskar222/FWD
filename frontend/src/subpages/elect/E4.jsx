    ...
    <div className="min-h-screen bg-[#e2d7c1] text-[#1a1a1a] font-sans">
      ...
      <section className="text-center px-6 md:px-20 py-16 bg-gradient-to-b from-amber-100 to-white">
        ...
        <p className="text-[#000000] text-lg max-w-3xl mx-auto leading-relaxed">
          From indoor ambient lighting to outdoor and decorative fixtures, our professionals ensure safe, stylish, and efficient lighting installation tailored to your space.
        </p>
      </section>
      ...
      <section className="px-8 md:px-20 py-20 max-w-4xl mx-auto">
        ...
        <div className="space-y-6">
          {[
            "Certified lighting experts assess your indoor, outdoor, or decorative lighting needs.",
            "They follow safety standards and use premium fixtures and wiring materials.",
            "Post-installation testing ensures brightness, safety, and functional performance.",
          ].map((text, index) => (
            <motion.div
              key={index}
        ...
        <div className="mt-16 bg-white rounded-xl shadow-lg p-8 border border-gray-100">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 text-center">
            ...
            <div>
              ...
              <p className="text-xl text-black mt-2">₹800 – ₹3,500</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="text-center bg-gradient-to-r from-[#eac38c] to-[#e2ab34] text-black py-20">
        <h2 className="text-3xl font-light mb-6">Ready to Brighten Up Your Space?</h2>
        <Link to="/booking/l1">
          <motion.button
            whileHover={{ scale: 1.05 }}
            className="bg-black text-white px-10 py-4 text-lg rounded-full hover:bg-gray-800 transition"
          >
            Book Lighting Installation Service
          </motion.button>
        </Link>
      </section>
    </div>
