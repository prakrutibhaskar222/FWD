    ...
    <div className="min-h-screen bg-[#e2d7c1] text-[#1a1a1a] font-sans">
      ...
      <section className="text-center px-6 md:px-20 py-16 bg-gradient-to-b from-amber-100 to-white">
        ...
        <p className="text-[#000000] text-lg max-w-3xl mx-auto leading-relaxed">
          Upgrade your home with intelligent lighting, voice-enabled controls, and automation
          that adds comfort, efficiency, and modern convenience to your space.
        </p>
      </section>
      ...
      <section className="px-8 md:px-20 py-20 max-w-4xl mx-auto">
        ...
        <div className="space-y-6">
          {[
            "A trained technician visits your home to assess existing switches, wiring, and smart-device compatibility.",
            "Smart bulbs, controllers, hubs, or voice-assistant integrations are configured and installed.",
            "After setup, the technician tests automation routines and guides you through app controls.",
          ].map((text, index) => (
            <motion.div
              key={index}
        ...
        <div className="mt-16 bg-white rounded-xl shadow-lg p-8 border border-gray-100">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 text-center">
            ...
            <div>
              ...
              <p className="text-xl text-black mt-2">₹2,500 – ₹6,000</p>
            </div>
          </div>
        </div>
      </section>
