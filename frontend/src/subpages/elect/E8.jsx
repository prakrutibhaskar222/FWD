...
export default function EarthingSurgeProtection() {
  return (
    <div className="min-h-screen bg-[#e2d7c1] text-[#1a1a1a] font-sans">
      ...
      <section className="text-center px-6 md:px-20 py-16 bg-gradient-to-b from-amber-100 to-white">
        ...
        <p className="text-[#000000] text-lg max-w-3xl mx-auto leading-relaxed">
          Ensure maximum electrical safety with professional earthing installation and surge protection solutions for homes and commercial spaces.
        </p>
      </section>
      ...
      <section className="px-8 md:px-20 py-20 max-w-4xl mx-auto">
        ...
        <div className="space-y-6">
          {[
            "Certified electricians inspect your electrical system and grounding requirements.",
            "Proper earthing pits, conductors, and surge protectors are installed following safety standards.",
            "Final testing ensures reliable fault protection and long-term stability.",
          ].map((text, index) => (
            <motion.div
              key={index}
        ...
        <div className="mt-16 bg-white rounded-xl shadow-lg p-8 border border-gray-100">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 text-center">
            <div>
              ...
              <p className="text-xl text-black mt-2">3–6 hours</p>
            </div>
            <div>
              <p className="text-gray-600 font-medium">💰 Price Range</p>
              <p className="text-xl text-black mt-2">₹2,000 – ₹6,000</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="text-center bg-gradient-to-r from-[#eac38c] to-[#e2ab34] text-black py-20">
        <h2 className="text-3xl font-light mb-6">Secure Your Electrical System Today</h2>
        <Link to="/booking/e2">
          <motion.button
            whileHover={{ scale: 1.05 }}
            className="bg-black text-white px-10 py-4 text-lg rounded-full hover:bg-gray-800 transition"
          >
            Book Earthing & Surge Protection Service
          </motion.button>
        </Link>
      </section>
    </div>
