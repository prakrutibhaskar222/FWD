    ...
    <div className="min-h-screen bg-[#e2d7c1] text-[#1a1a1a] font-sans">
      ...
      <section className="text-center px-6 md:px-20 py-16 bg-gradient-to-b from-amber-100 to-white">
        ...
        <p className="text-[#000000] text-lg max-w-3xl mx-auto leading-relaxed">
          Expert installation of doors, windows, and curtains with precise measurements, secure fittings, proper alignment, and a clean, professional finish.
        </p>
      </section>
      ...
      <section className="px-8 md:px-20 py-20 max-w-4xl mx-auto">
        ...
        <div className="space-y-6">
          {[
            "Technicians assess measurements, surface type, and installation requirements before beginning the work.",
            "Hardware components such as hinges, rods, and frames are securely drilled and fitted to ensure proper alignment and stability.",
            "Doors, windows, or curtains are installed with final adjustments, smooth operation checks, and cleanup afterward.",
          ].map((text, index) => (
            <motion.div
              key={index}
        ...
        <div className="mt-16 bg-white rounded-xl shadow-lg p-8 border border-gray-100">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 text-center">
            ...
            <div>
              ...
              <p className="text-xl text-black mt-2">₹600 – ₹2,000</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="text-center bg-gradient-to-r from-[#eac38c] to-[#e2ab34] text-black py-20">
        <h2 className="text-3xl font-light mb-6">Ready for a Smooth & Professional Installation?</h2>
        <Link to="/booking/i8">
          <motion.button
