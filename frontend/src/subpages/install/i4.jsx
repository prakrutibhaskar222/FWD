    ...
    <div className="min-h-screen bg-[#e2d7c1] text-[#1a1a1a] font-sans">
      ...
      <section className="text-center px-6 md:px-20 py-16 bg-gradient-to-b from-amber-100 to-white">
        <h1 className="text-5xl md:text-6xl font-bold mb-4">
          Air Conditioner Installation / Uninstallation ❄️
        </h1>
        <p className="text-[#000000] text-lg max-w-3xl mx-auto leading-relaxed">
          Professional AC installation and uninstallation services ensuring secure mounting, proper gas handling, safe electrical connections, and optimal cooling performance.
        </p>
      </section>
      ...
      <section className="px-8 md:px-20 py-20 max-w-4xl mx-auto">
        ...
        <div className="space-y-6">
          {[
            "Experts assess the AC type, tonnage, wall strength, and installation requirements before starting the process.",
            "AC units are mounted securely, with correct drilling, copper piping setup, insulation, and electrical safety checks.",
            "Technicians perform cooling tests, gas leak checks, and guide you on optimal AC usage and maintenance.",
          ].map((text, index) => (
            <motion.div
              key={index}
        ...
        <div className="mt-16 bg-white rounded-xl shadow-lg p-8 border border-gray-100">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 text-center">
            ...
            <div>
              ...
              <p className="text-xl text-black mt-2">₹1,200 – ₹3,500</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="text-center bg-gradient-to-r from-[#eac38c] to-[#e2ab34] text-black py-20">
        <h2 className="text-3xl font-light mb-6">Ready to Install or Uninstall Your AC?</h2>
        <Link to="/booking/i4">
          <motion.button
