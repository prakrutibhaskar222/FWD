    ...
    <div className="min-h-screen bg-[#e2d7c1] text-[#1a1a1a] font-sans">
      ...
      <section className="text-center px-6 md:px-20 py-16 bg-gradient-to-b from-amber-100 to-white">
        ...
        <p className="text-[#000000] text-lg max-w-3xl mx-auto leading-relaxed">
          Professional installation of geysers, taps, and shower panels with expert plumbing support, secure fittings, and leak-proof results.
        </p>
      </section>
      ...
      <section className="px-8 md:px-20 py-20 max-w-4xl mx-auto">
        ...
        <div className="space-y-6">
          {[
            "A trained plumber inspects your bathroom layout and verifies water inlet/outlet points.",
            "Geysers, taps, and shower panels are installed securely with proper sealing and alignment.",
            "Final testing is done to ensure there are no leaks and all fittings operate smoothly.",
          ].map((text, index) => (
            <motion.div
              key={index}
        ...
        <div className="mt-16 bg-white rounded-xl shadow-lg p-8 border border-gray-100">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 text-center">
            ...
            <div>
              ...
              <p className="text-xl text-black mt-2">₹500 – ₹2,000</p>
            </div>
          </div>
        </div>
      </section>
