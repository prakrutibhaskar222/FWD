...
export default function HomeCleaningSanitization({ setActive }) {
  return (
    <div className="min-h-screen bg-[#e2d7c1] text-[#1a1a1a] font-sans">
      ...
      <section className="text-center px-6 md:px-20 py-16 bg-gradient-to-b from-amber-100 to-white">
        ...
        <p className="text-black text-lg max-w-3xl mx-auto leading-relaxed">
          Keep your home spotless and germ-free with our professional cleaning 
          and sanitization service. We ensure deep cleaning of every corner 
          followed by hospital-grade disinfectant application for a safe and 
      ...
      <section className="px-8 md:px-20 py-20 max-w-4xl mx-auto">
        ...
        <div className="space-y-6">
          {[
            "We inspect the entire home to understand cleaning and sanitization requirements.",
            "Deep cleaning of floors, furniture, high-touch surfaces, kitchen, bathroom, and windows.",
            "Complete sanitization using safe, certified disinfectants to eliminate viruses and bacteria.",
          ].map((text, index) => (
            <motion.div
              key={index}
        ...
        <div className="mt-16 bg-white rounded-xl shadow-lg p-8 border border-gray-100">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 text-center">
            <div>
              ...
              <p className="text-xl text-black mt-2">3 – 8 hours</p>
            </div>
            <div>
              <p className="text-gray-600 font-medium">💰 Price</p>
              <p className="text-xl text-black mt-2">₹1,500 – ₹6,000</p>
            </div>
          </div>
        </div>
      </section>
