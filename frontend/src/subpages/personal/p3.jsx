...
export default function LaundryDryCleaning({ setActive }) {
  return (
    <div className="min-h-screen bg-[#e2d7c1] text-[#1a1a1a] font-sans">
      ...
      <section className="text-center px-6 md:px-20 py-16 bg-gradient-to-b from-amber-100 to-white">
        ...
        <p className="text-black text-lg max-w-3xl mx-auto leading-relaxed">
          Enjoy clean, fresh clothes without any hassle! Our pickup and delivery 
          laundry service includes washing, ironing, stain removal, and dry cleaning 
          to ensure your clothes look and feel brand new.
        </p>
      </section>
      ...
      <section className="px-8 md:px-20 py-20 max-w-4xl mx-auto">
        ...
        <div className="space-y-6">
          {[
            "We pick up your clothes at your preferred time and note any special cleaning requests.",
            "Your clothes are washed, dry cleaned, ironed, and neatly folded using premium detergents.",
            "Freshly cleaned clothes are delivered back to your doorstep on time.",
          ].map((text, index) => (
            <motion.div
              key={index}
        ...
        <div className="mt-16 bg-white rounded-xl shadow-lg p-8 border border-gray-100">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 text-center">
            <div>
              <p className="text-gray-600 font-medium">⏱ Turnaround Time</p>
              <p className="text-xl text-black mt-2">24 – 48 hours</p>
            </div>
            <div>
              <p className="text-gray-600 font-medium">💰 Price Range</p>
              <p className="text-xl text-black mt-2">₹20 – ₹150 per item</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="text-center bg-black text-white py-20">
        <h2 className="text-3xl font-light mb-6">Need Fresh, Clean Clothes?</h2>
