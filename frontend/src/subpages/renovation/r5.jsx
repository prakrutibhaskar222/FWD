...
export default function CarpentryWoodwork({ setActive }) {
  return (
    <div className="min-h-screen bg-[#e2d7c1] text-[#1a1a1a] font-sans">
      ...
      <section className="text-center px-6 md:px-20 py-16 bg-gradient-to-b from-amber-100 to-white">
        ...
        <p className="text-black text-lg max-w-3xl mx-auto leading-relaxed">
          From furniture repair and wardrobe installation to custom woodwork and 
          modular fittings — our skilled carpenters deliver durable, precise, 
          and beautifully finished solutions for your home.
        </p>
      </section>
      ...
      <section className="px-8 md:px-20 py-20 max-w-4xl mx-auto">
        ...
        <div className="space-y-6">
          {[
            "We inspect your carpentry requirements — repairs, new installation, or custom builds.",
            "Skilled carpenters work on measurements, cutting, assembling, polishing, and fittings.",
            "Final finishing, sanding, and alignment checks ensure long-lasting, high-quality results.",
          ].map((text, index) => (
            <motion.div
              key={index}
        ...
        <div className="mt-16 bg-white rounded-xl shadow-lg p-8 border border-gray-100">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 text-center">
            <div>
              ...
              <p className="text-xl text-black mt-2">2 – 8 hours</p>
            </div>
            <div>
              <p className="text-gray-600 font-medium">💰 Price Range</p>
              <p className="text-xl text-black mt-2">₹500 – ₹4,000</p>
            </div>
          </div>
        </div>
      </section>
