...
export default function CivilRenovation({ setActive }) {
  return (
    <div className="min-h-screen bg-[#e2d7c1] text-[#1a1a1a] font-sans">
      ...
      <section className="text-center px-6 md:px-20 py-16 bg-gradient-to-b from-amber-100 to-white">
        ...
        <p className="text-black text-lg max-w-3xl mx-auto leading-relaxed">
          Upgrade your home with professional civil renovation services. From wall 
          repairs and plastering to floor remodeling and tile installation, we ensure 
          strong, durable, and high-quality workmanship that enhances your living space.
        </p>
      </section>
      ...
      <section className="px-8 md:px-20 py-20 max-w-4xl mx-auto">
        ...
        <div className="space-y-6">
          {[
            "We evaluate your walls, floors, and tile areas to understand renovation needs.",
            "Our skilled team performs repairs, plastering, leveling, tiling, grouting, and finishing work.",
            "Final polishing, cleanup, and inspection ensure high-quality, long-lasting results.",
          ].map((text, index) => (
            <motion.div
              key={index}
        ...
        <div className="mt-16 bg-white rounded-xl shadow-lg p-8 border border-gray-100">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 text-center">
            <div>
              ...
              <p className="text-xl text-black mt-2">1 – 7 days</p>
            </div>
            <div>
              <p className="text-gray-600 font-medium">💰 Price Range</p>
              <p className="text-xl text-black mt-2">₹3,000 – ₹15,000</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="text-center bg-black text-white py-20">
        <h2 className="text-3xl font-light mb-6">Ready to Renovate Your Home?</h2>
