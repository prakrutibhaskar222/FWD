...
export default function BathroomKitchenRemodeling({ setActive }) {
  return (
    <div className="min-h-screen bg-[#e2d7c1] text-[#1a1a1a] font-sans">
      ...
      <section className="text-center px-6 md:px-20 py-16 bg-gradient-to-b from-amber-100 to-white">
        ...
        <p className="text-black text-lg max-w-3xl mx-auto leading-relaxed">
          Transform your bathroom and kitchen with modern designs, durable 
          materials, and high-quality craftsmanship. From tile replacement 
          and plumbing upgrades to modular fittings and complete layout redesign— 
      ...
      <section className="px-8 md:px-20 py-20 max-w-4xl mx-auto">
        ...
        <div className="space-y-6">
          {[
            "We evaluate the existing structure, plumbing, electrical layout, and design preferences.",
            "Our team performs demolition, tile replacement, plumbing fixes, countertop installation, and fitting upgrades.",
            "Final finishing includes polishing, sealing, cleaning, and quality checks for a flawless modern look.",
          ].map((text, index) => (
            <motion.div
              key={index}
        ...
        <div className="mt-16 bg-white rounded-xl shadow-lg p-8 border border-gray-100">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 text-center">
            <div>
              ...
              <p className="text-xl text-black mt-2">3 – 10 days</p>
            </div>
            <div>
      ...
      <section className="text-center bg-black text-white py-20">
        <h2 className="text-3xl font-light mb-6">
          Ready to Upgrade Your Bathroom or Kitchen?
        </h2>
