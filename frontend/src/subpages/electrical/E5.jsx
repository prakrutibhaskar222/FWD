...
export default function InverterUPSSetup() {
  return (
    <div className="min-h-screen bg-[#e2d7c1] text-[#1a1a1a] font-sans">
      ...
      <section className="text-center px-6 md:px-20 py-16 bg-gradient-to-b from-amber-100 to-white">
        ...
        <p className="text-[#000000] text-lg max-w-3xl mx-auto leading-relaxed">
          Ensure uninterrupted power at home or workplace with professional installation of inverters and UPS systems—safe, efficient, and compliant.
        </p>
      </section>
      ...
      <section className="px-8 md:px-20 py-20 max-w-4xl mx-auto">
        ...
        <div className="space-y-6">
          {[
            "Certified technicians inspect your wiring, load capacity, and suitability for inverter or UPS installation.",
            "Proper mounting, wiring, and battery connection are carried out following safety standards.",
            "Post-installation checks ensure backup activation, wiring integrity, and smooth power transition.",
          ].map((text, index) => (
            <motion.div
              key={index}
        ...
        <div className="mt-16 bg-white rounded-xl shadow-lg p-8 border border-gray-100">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 text-center">
            ...
            <div>
              ...
              <p className="text-xl text-black mt-2">₹1,200 – ₹3,000</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="text-center bg-gradient-to-r from-[#eac38c] to-[#e2ab34] text-black py-20">
        <h2 className="text-3xl font-light mb-6">Need Reliable Backup Power?</h2>
        <Link to="/booking/i1">
          <motion.button
            whileHover={{ scale: 1.05 }}
            className="bg-black text-white px-10 py-4 text-lg rounded-full hover:bg-gray-800 transition"
          >
            Book Inverter & UPS Setup Service
          </motion.button>
        </Link>
      </section>
